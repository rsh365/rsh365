...
function initIndex(){let request=new XMLHttpRequest();request.open("GET","../../rsh365/search.json");request.responseType="json";request.addEventListener("load",function(event){let documents=request.response;if(!documents)
